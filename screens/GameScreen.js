...
function GameScreen({ userNumber, onGameOver }) {
  ...
  function nextGuessHandler(direction) {
    if (
      ...
      Alert.alert("YOU ARE LIE!!!!!!!!!", "You know that this is wrong... :)", [
  ...
  const guessRoundsListLenght = guestRounds.length;
  ...
  return (
    <View style={styles.screen}>
      ...
      <View style={styles.listContainer}>
        {/* {guestRounds.map((guestRound) => (
          <Text key={guestRound}>{guestRound}</Text>
        ))} */}
        <FlatList
          data={guestRounds}
          renderItem={(itemData) => (
